...
- [ ] 1. Project scaffolding and infrastructure
  ...
  - [ ] 1.2 Create Docker and docker-compose setup
...
- [ ] 3. Authentication
  - [ ] 3.1 Implement register and login endpoints
  ...
  - [ ] 3.2 Write property test for authentication enforcement (Property 24)
  ...
  - [ ] 3.3 Write property test for JWT expiry (Property 26)
    - **Property 26: JWT Expiry**
    - **Validates: Requirements 11.4**
    - For any JWT with issuance time > 24 hours ago, assert the system returns HTTP 401
    - File: `tests/property/test_api_props.py`

  - [ ] 3.4 Write property test for authorization enforcement (Property 25)
...
- [ ] 4. Ingestion Service
  - [ ] 4.1 Implement GitHub URL ingestion
  ...
  - [ ] 4.2 Implement ZIP upload ingestion
  ...
  - [ ] 4.3 Write property test for invalid URL rejection (Property 1)
  ...
  - [ ] 4.4 Write property test for ZIP path traversal containment (Property 2)
  ...
  - [ ] 4.5 Write property test for invalid ZIP rejection (Property 3)
...
- [ ] 5. Parser
  - [ ] 5.1 Implement language detection and file tree builder
  ...
  - [ ] 5.2 Implement tree-sitter AST extraction
  ...
  - [ ] 5.4 Write property test for language detection accuracy (Property 4)
  ...
  - [ ] 5.5 Write property test for file tree completeness (Property 5)
  ...
  - [ ] 5.6 Write property test for parser resilience (Property 6)
  ...
  - [ ] 5.7 Write property test for AST extraction completeness (Property 7)
...
- [ ] 6. Analysis Engine
  ...
  - [ ] 6.2 Implement Pass 2 — Dependency Detection
  ...
  - [ ] 6.4 Write property test for dependency graph completeness (Property 9)
  ...
  - [ ] 6.5 Write property test for circular dependency detection (Property 10)
  ...
  - [ ] 6.6 Write property test for external dependency completeness (Property 11)
  ...
  - [ ] 6.7 Write unit tests for analysis engine
...
- [ ] 8. Knowledge Builder
  ...
  - [ ] 8.2 Implement embedding generation and pgvector storage
  ...
  - [ ] 8.3 Write property test for knowledge hierarchy completeness (Property 12)
  ...
  - [ ] 8.4 Write property test for function chunking bound (Property 13)
    - **Property 13: Function Chunking Bound**
    - **Validates: Requirements 6.5**
    - For any function body > 200 lines, assert every chunk contains at most 200 lines
    - File: `tests/property/test_knowledge_props.py`

  - [ ] 8.5 Write property test for embedding storage round-trip (Property 14)
  ...
  - [ ] 8.6 Write property test for semantic retrieval count (Property 15)
  ...
  - [ ] 8.7 Write unit tests for knowledge builder
...
- [ ] 9. Explanation Engine
  - [ ] 9.1 Implement semantic retrieval and prompt construction
  ...
  - [ ] 9.2 Implement OpenAI chat completions with retry logic
  ...
  - [ ] 9.3 Write property test for per-file explanation completeness (Property 16)
  ...
  - [ ] 9.4 Write property test for OpenAI retry behavior (Property 17)
  ...
  - [ ] 9.5 Write unit tests for explanation engine
...
- [ ] 10. Celery pipeline wiring and job orchestration
  - [ ] 10.1 Create Celery app and task chain
  ...
  - [ ] 10.2 Implement Cleanup Service and timeout watchdog
  ...
  - [ ] 10.3 Write property test for cleanup after terminal state (Property 29)
  ...
  - [ ] 10.4 Write property test for timeout watchdog (Property 30)
  ...
  - [ ] 10.5 Write unit tests for cleanup service
...
- [ ] 11. FastAPI REST API
  ...
  - [ ] 11.2 Implement job status and results endpoints
  ...
  - [ ] 11.3 Implement rate limiting middleware
  ...
  - [ ] 11.6 Write property test for job status response shape (Property 19)
  ...
  - [ ] 11.7 Write property test for job terminal state correctness (Property 20)
  ...
  - [ ] 11.8 Write property test for job isolation (Property 21)
  ...
  - [ ] 11.9 Write property test for rate limit enforcement (Property 27)
  ...
  - [ ] 11.10 Write unit tests for API auth endpoints
...
- [ ] 13. Next.js frontend — submission and job pages
  - [ ] 13.1 Implement submission form page (`/`)
  ...
  - [ ] 13.2 Implement job progress polling
  ...
  - [ ] 13.3 Implement three-tab results view
  ...
  - [ ] 13.4 Implement progressive rendering and failed state
  ...
  - [ ] 13.5 Write property test for polling interval bound (Property 22)
    ...
    - File: `frontend/__tests__/polling.test.tsx`

  - [ ] 13.6 Write property test for progressive rendering (Property 23)
    ...
    - File: `frontend/__tests__/progressive-render.test.tsx`

  - [ ] 13.7 Write unit tests for results tabs
    ...
    - File: `frontend/__tests__/results-tabs.test.tsx`

- [ ] 14. Integration tests
  - [ ] 14.1 Write end-to-end pipeline integration test
...
- The backend uses Python (FastAPI, Celery, Hypothesis); the frontend uses TypeScript (Next.js, fast-check)
